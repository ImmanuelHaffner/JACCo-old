...
{
  int ii, jj, kk;
  int ***array3, ***array2 = ((void *)0), ***array = ((void *)0);

  array = (int ***) malloc (sizeof (int **) * 10);
  array2 = (int ***) malloc (sizeof (int **) * 10);
  for (ii = 0; ii < 10; ii++) {
    array[ii] = (int **) malloc (sizeof (int *) * 10);
    array2[ii] = (int **) malloc (sizeof (int *) * 10);
    for (jj = 0; jj < 10; jj++) {
      array[ii][jj] = (int *) malloc (sizeof (int) * 10);
      array2[ii][jj] = (int *) malloc (sizeof (int) * 10);
    }
  }
 ...
 array2[ii][jj][kk]= 2;
  ...
  array3 = func2 ((int ***)array, (int ***)array2, 10);

  for (ii = 0; ii < 10; ii++) {
    for (jj = 0; jj < 10; jj++) {
      for (kk = 0; kk < 10; kk++) {
 if (array3[ii][jj][kk] != (7 + 10))
          return 1;
      }
    }
  }
